...
namespace Firebase
{
	internal class AppUtilPINVOKE
	{
		protected class SWIGExceptionHelper
		{
			...
			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate applicationDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate arithmeticDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate divideByZeroDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate indexOutOfRangeDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate invalidCastDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate invalidOperationDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate ioDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate nullReferenceDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate outOfMemoryDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate overflowDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate systemDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionArgumentDelegate argumentDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionArgumentDelegate argumentNullDelegate;

			private static AppUtilPINVOKE.SWIGExceptionHelper.ExceptionArgumentDelegate argumentOutOfRangeDelegate;

			static SWIGExceptionHelper()
			{
				AppUtilPINVOKE.SWIGExceptionHelper.applicationDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingApplicationException);
				AppUtilPINVOKE.SWIGExceptionHelper.arithmeticDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingArithmeticException);
				AppUtilPINVOKE.SWIGExceptionHelper.divideByZeroDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingDivideByZeroException);
				AppUtilPINVOKE.SWIGExceptionHelper.indexOutOfRangeDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingIndexOutOfRangeException);
				AppUtilPINVOKE.SWIGExceptionHelper.invalidCastDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingInvalidCastException);
				AppUtilPINVOKE.SWIGExceptionHelper.invalidOperationDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingInvalidOperationException);
				AppUtilPINVOKE.SWIGExceptionHelper.ioDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingIOException);
				AppUtilPINVOKE.SWIGExceptionHelper.nullReferenceDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingNullReferenceException);
				AppUtilPINVOKE.SWIGExceptionHelper.outOfMemoryDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingOutOfMemoryException);
				AppUtilPINVOKE.SWIGExceptionHelper.overflowDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingOverflowException);
				AppUtilPINVOKE.SWIGExceptionHelper.systemDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingSystemException);
				AppUtilPINVOKE.SWIGExceptionHelper.argumentDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionArgumentDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingArgumentException);
				AppUtilPINVOKE.SWIGExceptionHelper.argumentNullDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionArgumentDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingArgumentNullException);
				AppUtilPINVOKE.SWIGExceptionHelper.argumentOutOfRangeDelegate = new AppUtilPINVOKE.SWIGExceptionHelper.ExceptionArgumentDelegate(AppUtilPINVOKE.SWIGExceptionHelper.SetPendingArgumentOutOfRangeException);
		...
		protected class SWIGStringHelper
		{
			...
			private static AppUtilPINVOKE.SWIGStringHelper.SWIGStringDelegate stringDelegate;

			static SWIGStringHelper()
			{
				AppUtilPINVOKE.SWIGStringHelper.stringDelegate = new AppUtilPINVOKE.SWIGStringHelper.SWIGStringDelegate(AppUtilPINVOKE.SWIGStringHelper.CreateString);
		...
		protected static AppUtilPINVOKE.SWIGExceptionHelper swigExceptionHelper;

		protected static AppUtilPINVOKE.SWIGStringHelper swigStringHelper;

		static AppUtilPINVOKE()
		{
			AppUtilPINVOKE.swigExceptionHelper = new AppUtilPINVOKE.SWIGExceptionHelper();
			AppUtilPINVOKE.swigStringHelper = new AppUtilPINVOKE.SWIGStringHelper();
		}
