...
namespace Firebase {
    internal class CleanupNotifier {
        ...
        private class ObjectCleanupContext {
            ...
            public CleanupNotifier.DisposeObjectDelegate DisposeObject {
                get;
                set;
            }

            public CleanupNotifier.DeleteObjectDelegate DeleteObject {
                get;
                set;
            }

            public IntPtr CleanupObjectCPtr {
                get;
                set;
            }

            public IntPtr NotifyObjectCPtr {
                get;
                set;
            }
        }
        ...
        [CompilerGenerated]
        private static CleanupNotifierBridge.CleanupDelegate f__mgcache0;
