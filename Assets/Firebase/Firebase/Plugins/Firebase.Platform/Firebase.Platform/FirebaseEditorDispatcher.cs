...
namespace Firebase.Platform
{
	...
	{
		[CompilerGenerated]
		private static Action f__mgcache0;

		[CompilerGenerated]
		private static Action f__mgcache1;

		[CompilerGenerated]
		private static Action f__mgcache2;
		...
		public static void StartEditorUpdate()
		{
			...
			if (editorApplicationType != null)
			{
				FieldInfo arg_3B_0 = editorApplicationType.GetField("update");
				if (FirebaseEditorDispatcher.f__mgcache0 == null)
				{
					FirebaseEditorDispatcher.f__mgcache0 = new Action(FirebaseEditorDispatcher.Update);
				}
				FirebaseEditorDispatcher.AddRemoveCallbackToField(arg_3B_0, FirebaseEditorDispatcher.f__mgcache0, null, true, "Firebase failed to register for editor update calls. Most Firebase features will fail, as callbacks will notwork properly. This is caused by being unable to resolvethe necessary fields from the UnityEditor.dll.");
			}
		}
		...
		public static void StopEditorUpdate()
		{
			...
			if (editorApplicationType != null)
			{
				FieldInfo arg_37_0 = editorApplicationType.GetField("update");
				if (FirebaseEditorDispatcher.f__mgcache1 == null)
				{
					FirebaseEditorDispatcher.f__mgcache1 = new Action(FirebaseEditorDispatcher.Update);
				}
				FirebaseEditorDispatcher.AddRemoveCallbackToField(arg_37_0, FirebaseEditorDispatcher.f__mgcache1, null, false, null);
			}
		}
		...
		public static void ListenToPlayState(bool start = true)
		{
			...
			if (editorApplicationType != null)
			{
				...
				if (@event != null)
				{
					...
					if (type != null)
					{
						MethodInfo methodInfo = typeof(FirebaseEditorDispatcher).GetMethod("PlayModeStateChangedWithArg", BindingFlags.NonPublic | BindingFlags.Static);
				...
				if (FirebaseEditorDispatcher.f__mgcache2 == null)
				{
					FirebaseEditorDispatcher.f__mgcache2 = new Action(FirebaseEditorDispatcher.PlayModeStateChanged);
				}
				Action callback = FirebaseEditorDispatcher.f__mgcache2;
